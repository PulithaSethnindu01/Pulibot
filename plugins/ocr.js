...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Pulibot.addCMD({pattern: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Pulibot.addCMD({pattern: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC, dontAddCMDList: true}, (async (message, match) => { 
