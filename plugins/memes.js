...
if (Config.WORKTYPE == 'private') {
	      ...
	      Pulibot.addCMD({pattern: 'mpack', fromMe: true, desc: Ln,}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'mme ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {   
	...
	Pulibot.addCMD({ pattern: 'bocca ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
     ...
     Pulibot.addCMD({ pattern: 'mymeme ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
       ...
       Pulibot.addCMD({ pattern: 'santha ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
      ...
      Pulibot.addCMD({ pattern: 'chaina ?(.*)', fromMe: true, dontAddCMDList: true}, (async (message, match) => {
        ...
        Pulibot.addCMD({ pattern: 'bomu ?(.*)', fromMe: true, dontAddCMDList: true}, (async (message, match) => {
  ...
  Pulibot.addCMD({ pattern: 'saduni ?(.*)', fromMe: true, dontAddCMDList: true}, (async (message, match) => {
  ...
  Pulibot.addCMD({ pattern: 'tharindu ?(.*)', fromMe: true, dontAddCMDList: true}, (async (message, match) => {
...
//=========================================================================================================================================================================================================================================================================================
    ...
    Pulibot.addCMD({pattern: 'mpack', fromMe: false, desc: Ln,}, (async (message, match) => {
      ...
      Pulibot.addCMD({ pattern: 'bocca ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {
       ...
       Pulibot.addCMD({ pattern: 'mymeme ?(.*)', fromMe: false , dontAddCMDList: true}, (async (message, match) => {
       ...
       Pulibot.addCMD({ pattern: 'santha ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {
        ...
        Pulibot.addCMD({ pattern: 'chaina ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(lasiyasimg.data), MessageType.image, { mimetype: Mimetype.jpg, caption: Config.CAPTION_KEY})
          ...
          Pulibot.addCMD({ pattern: 'bomu ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {
  ...
  Pulibot.addCMD({ pattern: 'saduni ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {
  ...
  Pulibot.addCMD({ pattern: 'tharindu ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {
...
Pulibot.addCMD({pattern: 'mme ?(.*)', fromMe: false, dontAddCMDList: true}, (async (message, match) => {    
...
Pulibot.addCMD({pattern: 'mpack', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
