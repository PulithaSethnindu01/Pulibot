...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'neko', fromMe: false, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC, dontAddCMDList: true}, (async (message, match) => {
