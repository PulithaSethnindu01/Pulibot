...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'tblend ?(.*)', fromMe: true, desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    Pulibot.addCMD({pattern: 'tblend ?(.*)', fromMe: false, desc: Lang.T_DESC}, (async (message, match) => {    
    ...
    Pulibot.addCMD({pattern: 'tblend ?(.*)', fromMe: true, desc: Lang.T_DESC, dontAddCMDList: true}, (async (message, match) => {    
