...
if (Config.LANG == 'EN') {
    ...
    Pulibot.addCMD({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'help ?(.*)', fromMe: true, desc: h_DedSI}, (async (message, match) => {
