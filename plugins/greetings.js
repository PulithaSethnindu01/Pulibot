...
Pulibot.addCMD({pattern: 'welcome$', fromMe: true, desc: Lang.WELCOME_DESC}, (async (message, match) => {
...
Pulibot.addCMD({pattern: 'welcome (.*)', fromMe: true, dontAddCMDList: true}, (async (message, match) => {
    if (match[1] === '') {
...
Pulibot.addCMD({pattern: 'goodbye$', fromMe: true, desc: Lang.GOODBYE_DESC}, (async (message, match) => {
...
Pulibot.addCMD({pattern: 'goodbye (.*)', fromMe: true, dontAddCMDList: true}, (async (message, match) => {
    if (match[1] === '') {
