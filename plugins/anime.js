...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({ pattern: 'rloli ?(.*)', fromMe: true,dontAddCMDList: true }, (async (message, match) => {
    ...
    Pulibot.addCMD({ pattern: 'rwifu ?(.*)', fromMe: true,dontAddCMDList: true }, (async (message, match) => {
    ...
    Pulibot.addCMD({ pattern: 'rwolf ?(.*)', fromMe: true,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rshin ?(.*)', fromMe: true,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rwtc ?(.*)', fromMe: true,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rloli ?(.*)', fromMe: false,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rwifu ?(.*)', fromMe: false,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rwolf ?(.*)', fromMe: false,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rshin ?(.*)', fromMe: false,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
    ...
    Pulibot.addCMD({ pattern: 'rwtc ?(.*)', fromMe: false,dontAddCMDList: true }, (async (message, match) => {
        await axios.get(`https://tinyurl.com/${Config.LOCKR}`).then(async (ann) => {
            const { lasi } = ann.data.def1
            const lc = lasi
            const seed = Config.LOCK
