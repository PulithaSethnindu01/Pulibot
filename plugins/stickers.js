...
if (Config.WORKTYPE == 'private') {
    Pulibot.addCMD({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Pulibot.addCMD({pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Pulibot.addCMD({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontAddCMDList: true}, (async (message, match) => {    
