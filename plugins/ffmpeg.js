...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC, dontAddCMDList: true}, (async (message, match) => {
