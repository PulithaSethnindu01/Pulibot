...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'ipack', fromMe: true, deleteCommand: false, desc: I_DESC}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'sysd', fromMe: true, desc: Lang.SYSD_DESC,dontAddCMDList: true}, (async (message, match) => {
    ...
    Pulibot.addCMD({ pattern: 'info', fromMe: true,deleteCommand: false,deleteCommand: false,desc: LW.PL_DESC,dontAddCMDList: true }, async (message, match) => { 
    ...
    Pulibot.addCMD({ pattern: 'inf$', fromMe: true, desc: LW.PL_DESC, dontAddCMDList: true }, async (message, match) => { 
        if (message.jid.includes('-')) {
            var lasijson = await message.client.groupMetadataMinimal(message.jid) 
            var code = await message.client.groupInviteCode(message.jid)
            var nwjson = await message.client.groupMetadata(message.jid) 
    ...
    Pulibot.addCMD({pattern: 'id ?(.*)', fromMe: true, desc: LP.JID_DESC, dontAddCMDList: true}, (async (message, match) => {    
    ...
    Pulibot.addCMD({pattern: 'bot', fromMe: true, deleteCommand: false,desc:'Get info aboout bot'}, (async (message, match) => {
      var lasiyasimg = await axios.get(`https://telegra.ph/file/145ee2d4fb11363f72582.jpg`, { responseType: 'arraybuffer' })
      await message.client.sendMessage(message.jid, Buffer.from(lasiyasimg.data), MessageType.image, {mimetype: Mimetype.png, caption: '                  *♔ The Pulibot ♔* \n\n\n❍ 𝗛𝗼𝘀𝘁𝗲𝗱 ➤ 𝘼𝙒𝙎\n❍ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 ➤ 𝐕'+Config.VERSION+'\n❍ 𝗕𝗿𝗮𝗻𝗰𝗵  ➤ *'+Config.BRANCH+'*\n❍ 𝗔𝗯𝗼𝘂𝘁    ➤ Coded By Pulitha Sethnindu\n❍ 𝗢𝘄𝗻𝗲𝗿   ➤Pulitha Sethnindu\n❍ 𝗠𝗼𝗱𝗲𝗿𝘀 ➤┓\n                        ┣ @Pulithasethnindu\n❍ 𝗠𝗮𝗶𝗻 𝗚𝗿𝗼𝘂𝗽 ➤ Error 404\n\n❍ 𝐓𝐮𝐭𝐞 ➤ Coming Soon...\n⊱ ──────    ♔    ────── ⊰\n'})
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Pulibot.addCMD({pattern: 'ipack', fromMe: false, deleteCommand: false, desc: I_DESC}, (async (message, match) => {
       
        await message.sendMessage(I_PACK);
      }));

    Pulibot.addCMD({pattern: 'sysd', fromMe: false, desc: Lang.SYSD_DESC, dontAddCMDList: true}, (async (message, match) => {
    ...
    Pulibot.addCMD({ pattern: 'info', fromMe: false,deleteCommand: false, desc: LW.PL_DESC , dontAddCMDList: true}, async (message, match) => { 
    ...
    Pulibot.addCMD({ pattern: 'inf$', fromMe: false, desc: LW.PL_DESC, dontAddCMDList: true }, async (message, match) => { 
        if (message.jid.includes('-')) {
            var lasijson = await message.client.groupMetadataMinimal(message.jid) 
            var code = await message.client.groupInviteCode(message.jid)
            var nwjson = await message.client.groupMetadata(message.jid) 
    ...
    Pulibot.addCMD({pattern: 'id ?(.*)', fromMe: false, desc: Lang.JID_DESC, dontAddCMDList: true}, (async (message, match) => {    
        if (message.reply_message !== false) {
    ...
    Pulibot.addCMD({pattern: 'bot', fromMe: false, deleteCommand: false,desc:'Get info aboout bot'}, (async (message, match) => {
var lasiyasimg = await axios.get(`https://telegra.ph/file/145ee2d4fb11363f72582.jpg`, { responseType: 'arraybuffer' })
      await message.client.sendMessage(message.jid, Buffer.from(lasiyasimg.data), MessageType.image, {mimetype: Mimetype.png, caption: '                  *♔ The Pulibot ♔* \n\n\n❍ 𝗛𝗼𝘀𝘁𝗲𝗱 ➤ 𝘼𝙒𝙎\n❍ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 ➤ 𝐕'+Config.VERSION+'\n❍ 𝗕𝗿𝗮𝗻𝗰𝗵  ➤ *'+Config.BRANCH+'*\n❍ 𝗔𝗯𝗼𝘂𝘁    ➤ Coded By Pulitha Sethnindu\n❍ 𝗢𝘄𝗻𝗲𝗿   ➤Pulitha Sethnindu\n❍ 𝗠𝗼𝗱𝗲𝗿𝘀 ➤┓\n                        ┣ @Pulithasethnindu\n❍ 𝗠𝗮𝗶𝗻 𝗚𝗿𝗼𝘂𝗽 ➤ Error 404\n\n❍ 𝐓𝐮𝐭𝐞 ➤ Coming Soon...\n⊱ ──────    ♔    ────── ⊰\n'})
    }));
