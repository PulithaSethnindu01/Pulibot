...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'a ?(.*)', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
...
let id = match[1];
    ...
    Pulibot.addCMD({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Pulibot.addCMD({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
...
let id = match[1];
    ...
    Pulibot.addCMD({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC, dontAddCMDList: true}, (async (message, match) => {    
