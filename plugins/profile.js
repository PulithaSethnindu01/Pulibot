...
Pulibot.addCMD({pattern: 'kickme', fromMe: true, desc: Lang.KICKME_DESC, onlyGroup: true}, (async (message, match) => {
...
Pulibot.addCMD({pattern: 'pp', fromMe: true, desc: Lang.PP_DESC}, (async (message, match) => {    
...
Pulibot.addCMD({pattern: 'block ?(.*)', fromMe: true, desc: Lang.BLOCK_DESC}, (async (message, match) => {   
...
Pulibot.addCMD({pattern: 'unblock ?(.*)', fromMe: true, desc: Lang.UNBLOCK_DESC}, (async (message, match) => { 
