...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'carbon ?(.*)', fromMe: true, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'carbon ?(.*)', fromMe: false, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'carbon ?(.*)', fromMe: true, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN, dontAddCMDList: true}, (async (message, match) => {
