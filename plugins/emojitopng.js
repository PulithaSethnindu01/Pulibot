...
if (Config.WORKTYPE == 'private') {
    ...
    Pulibot.addCMD({pattern: 'png ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'png ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
    ...
    Pulibot.addCMD({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
