...
if (Config.WORKTYPE == 'private') {
    Pulibot.addCMD({ pattern: 'scan ?(.*)', fromMe: true, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    Pulibot.addCMD({ pattern: 'scan ?(.*)', fromMe: false, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    Pulibot.addCMD({ pattern: 'scan ?(.*)', fromMe: true, dontAddCMDList: true, desc: Lang.SCAN}, (async (message, match) => { 
