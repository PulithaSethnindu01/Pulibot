...
Pulibot.addCMD({ pattern: 'ig ?(.*)', fromMe: false, desc: IG_DESC}, async (message, match) => {
...
Pulibot.addCMD({ pattern: 'fb ?(.*)', fromMe: false, desc: FBDESC }, async (message, match) => {
